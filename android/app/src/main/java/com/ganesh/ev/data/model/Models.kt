...
enum class ConnectorType {
    CCS2, CHADEMO, GB_T, TESLA
}

enum class SlotStatus {
    AVAILABLE, RESERVED, BOOKED, CHARGING, MAINTENANCE
}
...
enum class BookingStatus {
    PENDING, CONFIRMED, ONGOING, COMPLETED, EXPIRED, CANCELLED
}
