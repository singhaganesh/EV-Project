...
interface ApiService {
    ...
    suspend fun sendOtp(@Query("mobileNumber") mobileNumber: String): Response<ApiResponse<Map<String, String>>>
    ...
    // Slot APIs
    @GET("api/slots")
    suspend fun getAllSlots(): Response<ApiResponse<List<ChargerSlot>>>
    
    @GET("api/slots/station/{stationId}")
    suspend fun getSlotsByStation(@Path("stationId") stationId: Long): Response<ApiResponse<List<ChargerSlot>>>
    
    @GET("api/slots/station/{stationId}/available")
    suspend fun getAvailableSlots(@Path("stationId") stationId: Long): Response<ApiResponse<List<ChargerSlot>>>
    
    // Booking APIs
    @GET("api/bookings")
    suspend fun getAllBookings(): Response<ApiResponse<List<Booking>>>
    
    @GET("api/bookings/user/{userId}")
    suspend fun getUserBookings(@Path("userId") userId: Long): Response<ApiResponse<List<Booking>>>
    ...
    suspend fun startCharging(@Body request: StartChargingRequest): Response<ApiResponse<ChargingSession>>
    
    @POST("api/charging/stop/{sessionId}")
    suspend fun stopCharging(@Path("sessionId") sessionId: Long): Response<ApiResponse<ChargingSession>>
    
    @GET("api/charging/session/{sessionId}")
    suspend fun getSession(@Path("sessionId") sessionId: Long): Response<ApiResponse<ChargingSession>>
    
    @GET("api/charging/booking/{bookingId}")
    suspend fun getSessionByBooking(@Path("bookingId") bookingId: Long): Response<ApiResponse<ChargingSession>>
    
    @GET("api/charging/user/{userId}")
    suspend fun getUserChargingHistory(@Path("userId") userId: Long): Response<ApiResponse<List<ChargingSession>>>
    
    // Payment APIs
    @POST("api/payments/create-intent/{bookingId}")
    suspend fun createPaymentIntent(@Path("bookingId") bookingId: Long): Response<ApiResponse<PaymentIntentResponse>>
    
    @GET("api/payments/booking/{bookingId}")
    suspend fun getPaymentStatus(@Path("bookingId") bookingId: Long): Response<ApiResponse<Payment>>
}
